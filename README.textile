...
pre. sudo gem install remarkable_rails
...
* route
* set_session
* set_the_flash matchers

In Remarkable 4.0, we also ported and extended redirect to and render template
from rspec rails matchers to provide I18n. You can also do:

pre. render_template 'edit', :layout => 'default'
respond_with 404, :content_type => Mime::XML, :body => /Not found/

== Macro stubs

Another cool feature in Remarkable 4.0 is macro stubs, which makes your mocks
...
pre. RAILS_ROOT/spec/remarkable
